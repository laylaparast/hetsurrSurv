...
Lastly, the second main function in this package is `test.multiplet` which test for heterogeneity across multiple time points. The arguments are similar, except that the first argument is the vector of time points for testing:
